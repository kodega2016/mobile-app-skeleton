...
abstract class $ThemeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AppThemeMode themeMode, AppThemeType themeType});
}
...
class _$ThemeStateImpl implements _ThemeState {
  const _$ThemeStateImpl({required this.themeMode, required this.themeType});
  ...
  @override
  String toString() {
    return 'ThemeState(themeMode: $themeMode, themeType: $themeType)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, themeMode, themeType);
...
abstract class _ThemeState implements ThemeState {
  const factory _ThemeState(
      ...
      required final AppThemeType themeType}) = _$ThemeStateImpl;
